...
function Dashboard() {
  ...
  // Se cuentan los productos con stock bajo
  ...
  // Carga inicial de categorías para el filtro del buscador
  useEffect(() => {
    const getCategories = async () => {
      try {
        ...
        // Si falla, el desplegable queda vacío sin romper la app
      }
    };
    getCategories();
  }, []);
  ...
  const handleEdit = async (data) => {
    try {
      ...
      setError(err.response?.data?.error || 'Error al editar el producto');
    }
  };
  ...
  // Filtro de productos y buscador
