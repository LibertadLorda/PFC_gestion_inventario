...
function ProductTable({ products, isAdmin, editingStock, newStock, setNewStock, setEditingStock, setEditingProduct, onStockUpdate, onDelete }) {
  ...
  /* Se comprueba que la página actual exista, 
    si no, se vuelve a la página 1 */
    ...
    <div>
      <div className="table-responsive">
        <table className="table table-bordered table-hover align-middle">
          ...
          <tbody>
            {/* Se muestran los productos de la página actual */}
              ...
              <tr key={product.id}>
                ...
                <td>
                  {editingStock === product.id ? (
                    ...
                    // Si el stock es menor q el mínimo, se visualiza en rojo con icono 
                ...
                <td>
                  ...
                  {/* Solo los administradores pueden editar o eliminar productos */}
                  {isAdmin && (
                    <>
                      <button
