...
// MOSTRAR USUARIOS DE LA EMPRESA (solo para rol admin) 
router.get('/', async (req, res) => {
  // Se valida que el usuario tenga el rol admministrador
...
// EDITAR USUARIO (solo para rol admin) 
...
// CAMBIAR ROL DE USUARIO (solo para rol admin)
